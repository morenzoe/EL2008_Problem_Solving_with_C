/*
*Deskripsi        : Program implementasi algoritma Dijkstra
*					untuk mencari jarak tempuh terpendek
*					antar 18 kota.
*Sumber Kode Asli : https://github.com/ReynaldoAverill/Tugas7PMC
*/
...
int main (){
    ...
    printf("Silahkan masukkan nama file database nama-nama kota: ");
    ...
    printf("Pembacaan nama-nama kota berhasil.\n");
    ...
    printf("Silahkan masukkan nama file yang berisi jarak antar masing-masing kota: ");
    ...
    while(progress=='y'){
        ...
        printf("\nBerikut adalah daftar nama-nama kota.\n");
        ...
        scanf(" %d",&idx_tujuan);
        idx_tujuan-=1;
        //Jarak akhir ke masing-masing kota, akan di update terus sesuai jarak yang ditemukan
		int jarak_final[n_kota];
        //Memberikan keterangan apakah jarak sudah minimum
		bool is_final[n_kota]; 
        //Indeks yang dilalui hingga mencapai tujuan
		int list_dilalui[n_kota][n_kota+1];
        //Mencatat jumlah vertex yang dilalui pada list_dilalui
		int idx_dilalui[n_kota];
        //Algoritma Dijsktra  
		...
		*/
        printf("Apakah anda masih ingin mengelilingi kota? [y/n]: ");
        scanf(" %c",&progress);
    }
}
